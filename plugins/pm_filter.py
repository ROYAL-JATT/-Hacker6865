...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b>ʜᴇʏ {user} 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ <a href=https://t.me/Movies_villae>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇</b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/Punjabi_movies_villa")]])
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://t.me/search_movie45p")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://t.me/search_movie45")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
    ...
    # don't change anything without contacting me @LazyDeveloperr
        ...
        buttons = [[
            ...
            InlineKeyboardButton('༄ؘ ۪۪۫۫Aᴜᴛᴏ FIʟᴛᴇʀ༄ؘ', callback_data='autofilter')
        ],[
        ...
        buttons = [[
             ...
             InlineKeyboardButton('·͙*̩̩͙˚̩̥̩̥*̩̩̥͙ᴛᴇʟᴇɢʀᴀᴘʜ*̩̩̥͙˚̩̥̩̥*̩̩͙‧͙', callback_data='tele') 
         ], [ 
             InlineKeyboardButton('˚*•̩̩͙ᴄᴏɴɴᴇᴄᴛɪᴏɴꜱ•̩̩͙*˚', callback_data='coct'), 
             InlineKeyboardButton('.•°✿ᴇᴀʀɴ ᴍᴏɴᴇʏ✿°•.', callback_data='shortlink_info') 
         ], [ 
             InlineKeyboardButton('*＊✿❀ғɪʟᴛᴇʀs❀✿＊*', callback_data='filters'), 
             InlineKeyboardButton('-ˋˏ ༻❁𝙷𝙾𝙼𝙴❁༺ ˎˊ-', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await client.edit_message_media(
            query.message.chat.id, 
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
                    InlineKeyboardButton("'╰┈➤❝[Cᴏɴᴛᴀᴄᴛ]", url="https://t.me/Hacker6865")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
