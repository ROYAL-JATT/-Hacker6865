...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="https://t.me/ROYAL_GAGAN_DEEP_SINGH_MEHRA")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('Support Group', url="https://t.me/+iVX24lYWqRZhZjFl"),
            InlineKeyboardButton('Owner', url="https://t.me/ROYAL_GAGAN_DEEP_SINGH_MEHRA")
        ],[
